...
const Dashboard = ({switchycardpreview}) => {
    return (
        <Header>
            <Navigation>
            ...
            <PrimaryHeader><Highlight>Switches</Highlight> Explore all of <Highlight>your Switchy´s</Highlight> <br></br> they will show you the beauty in Life</PrimaryHeader>
            <SubHeader>workout routine, holiday, full day of eating everything can be added here <br></br> they will bring joy in your life</SubHeader>
            <WrapperGrid>
                {switchycardpreview.filter(preview_rights => preview_rights.uid === 1).map(preview => (
