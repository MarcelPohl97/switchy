...
const Subscription = () => {
    return (
        <Header>
            ...
            <PrimaryHeader><Highlight>Subscription</Highlight> Plans for <Highlight>your Switchy´s</Highlight> <br></br> they will show you the beauty in Life</PrimaryHeader>
            <SubHeader>With our subscription plans you will get extra functionality so that <br></br> they will bring joy in your life</SubHeader>
        </Header>
    )
}
